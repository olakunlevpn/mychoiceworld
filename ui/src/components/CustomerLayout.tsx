...
const footerNavigation = {
  quickLinks: [
    { name: 'Discover', href: '/discover' },
    { name: 'Browse Stores', href: '/discover' },
    ...
    <div className="bg-gray-50 dark:bg-dark">
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="relative z-40 lg:hidden">
        ...
        <div className="fixed inset-0 z-40 flex">
          <DialogPanel
            transition
            className="relative flex w-full max-w-xs transform flex-col overflow-y-auto bg-gray-50 dark:bg-dark pb-12 shadow-xl transition duration-300 ease-in-out data-[closed]:-translate-x-full"
          >
            ...
            <div className="space-y-1 border-t border-gray-200 dark:border-gray-700 px-4 py-6">
              ...
              <button
                type="button"
                className="block w-full rounded-md px-3 py-3 text-left text-base font-medium text-red-400 hover:bg-gray-100 dark:hover:bg-white/5"
              >
                Logout
              </button>
            </div>
      ...
      <div className="bg-gray-50 dark:bg-dark">
        <header className="relative z-10">
          <nav aria-label="Top">
            ...
            <div className="bg-gray-200 dark:bg-white/10 backdrop-blur-md backdrop-filter">
                ...
                <div>
                  <div className="flex h-16 items-center justify-between">
                      ...
                      <div className="flex h-full items-center space-x-8 px-4">
                        {navLinks.map((link) => (
                          <Link
                            key={link.name}
                            to={link.href}
                            className="flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-primary-600 transition-colors"
                          >
                    ...
                    <div className="flex flex-1 items-center lg:hidden">
                      <button type="button" onClick={() => setMobileMenuOpen(true)} className="-ml-2 p-2 text-gray-900 dark:text-white">
                        <span className="sr-only">Open menu</span>
                        <Bars3Icon aria-hidden="true" className="size-6" />
                      </button>

                      <Link to="/search" className="ml-2 p-2 text-gray-900 dark:text-white">
                    ...
                    <div className="flex flex-1 items-center justify-end">
                      <Link to="/search" className="hidden p-2 text-gray-900 dark:text-white hover:text-primary-600 lg:block">
                        <span className="sr-only">Search</span>
                        <MagnifyingGlassIcon aria-hidden="true" className="size-6" />
                      </Link>
                      ...
                      <button
                        type="button"
                        onClick={toggleTheme}
                        className="p-2 text-gray-900 dark:text-white hover:text-primary-600 lg:ml-2"
                      >
                      ...
                      {/* Notification bell */}
                      <Link to="/notifications" className="relative p-2 text-gray-900 dark:text-white hover:text-primary-600 lg:ml-2">
                          ...
                          >
                            <div className="py-1">
                              <MenuItem>
                                <Link
                                  to="/reservations"
                                  className="block px-4 py-2 text-sm text-gray-600 dark:text-gray-300 data-[focus]:bg-gray-100 dark:data-[focus]:bg-white/5 data-[focus]:text-gray-900 dark:data-[focus]:text-white"
                                >
                                  My Reservations
                                </Link>
                              </MenuItem>
                              ...
                              <MenuItem>
                                <button
                                  type="button"
                                  className="block w-full px-4 py-2 text-left text-sm text-red-400 data-[focus]:bg-gray-100 dark:data-[focus]:bg-white/5"
                                >
                                  Logout
                                </button>
                              </MenuItem>
      ...
      {/* Footer */}
      <footer aria-labelledby="footer-heading" className="bg-gray-50 dark:bg-dark hidden lg:block">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-16 lg:grid lg:grid-cols-4 lg:gap-x-8">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <span className="inline-flex items-center gap-x-1.5 rounded-full border border-gray-600 px-3 py-1.5 text-xs font-medium text-gray-900 dark:text-white">
              ...
              <div className="mt-8">
                ...
                <div className="mt-4 flex space-x-4">
                  {socialLinks.map((item) => (
                    <a key={item.name} href={item.href} className="text-gray-500 dark:text-gray-400 hover:text-primary-600">
              ...
              <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form className="mt-4">
                  <input
                    ...
                    className="block w-full rounded-md border border-gray-600 bg-white dark:bg-dark px-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-primary-600 focus:outline-none focus:ring-1 focus:ring-primary-600"
                  />
                  <button
                    type="submit"
                    className="mt-3 flex w-full items-center justify-center gap-x-2 rounded-md bg-primary-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-gray-50 dark:focus:ring-offset-dark"
                  >
          ...
          <div className="border-t border-gray-200 dark:border-gray-800 py-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <a href="https://maylancer.org" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400">Webdesign Maylancer</a>
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center gap-0.5 rounded-lg px-3 py-1.5 text-[10px] font-medium transition-colors ${
                  active ? 'text-primary-600' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'
                }`}
              >
